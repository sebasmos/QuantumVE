...
# --------------------------------------------------------
"""
python finetune_mobile.py --accum_iter 4 --batch_size 64  --epochs 100 --blr 5e-4 --layer_decay 0.65 --weight_decay 0.05 --drop_path 0.1 --mixup 0.8 --cutmix 1.0 --reprob 0.25 --dist_eval --data_path ../data/ABGQI_mel_spectrograms --nb_classes 5 --output_dir quinn_5_classes_v7_may --input_size 224 --lr 0.0001 --warmup_epochs 10
"""
import sys
sys.path.insert(0,'../') 
import argparse
...
def get_args_parser():
    ...
    parser.add_argument('--output_dir', default='quinn_5_classes_7_may',
...
#         checkpoint = model#torch.load(args.finetune, map_location='cpu')
