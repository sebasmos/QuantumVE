...
# --------------------------------------------------------
"""
python pretrain.py --accum_iter 4 --batch_size 64  --epochs 100 --blr 5e-4 --layer_decay 0.65 --weight_decay 0.05 --drop_path 0.1 --mixup 0.8 --cutmix 1.0 --reprob 0.25 --dist_eval --data_path /home/sebastian/codes/QuantumVE/q_Net/data/ABGQI_mel_spectrograms --nb_classes 5 --output_dir mobilenetv4_r448 --input_size 224 --lr 0.0001 --warmup_epochs 10
"""
import sys
sys.path.insert(0,'../../MAE_backbones') 
sys.path.insert(0,'../part1_VE_extraction') 
import argparse
import torch
...
def get_args_parser():
    parser = argparse.ArgumentParser('MobileNet fine-tuning for image classification', add_help=False)
...
def main(args):
    ...
    if args.output_dir=="MobileNetv3_large_frozen":
        ...
        model = CustomModel(base_model=model, feat_space=args.nb_classes, model_name=args.output_dir)
